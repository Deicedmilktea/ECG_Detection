...
#define ADS1292R_PWDN_H HAL_GPIO_WritePin(ADS1292R_RES_GPIO_Port, ADS1292R_RES_Pin, GPIO_PIN_SET)
#define ADS1292R_PWDN_L HAL_GPIO_WritePin(ADS1292R_RES_GPIO_Port, ADS1292R_RES_Pin, GPIO_PIN_RESET)
...
void ADS1292R_ReadData(uint8_t *data);           // 读取72位的数据
